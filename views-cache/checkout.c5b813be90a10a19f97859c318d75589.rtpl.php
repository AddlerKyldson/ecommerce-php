											...
											<table class="shop_table">
												...
												<tfoot>
													<tr class="cart-subtotal">
														<th>Subtotal</th>
														<td><span class="amount">R$ <?php echo formatPrice(value.vlsubtotal); ?></span>
														</td>
													</tr>
													<tr class="shipping">
														<th>Frete</th>
														<td>
															R$ <?php echo formatPrice(value.vlfreight); ?>
													...
													<tr class="order-total">
														...
														<td><strong><span class="amount">R$ <?php echo formatPrice(value.vltotal); ?></span></strong> </td>
													</tr>
												</tfoot>
											</table>
											<div id="payment">
