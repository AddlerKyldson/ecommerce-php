...
class Cart extends Model{
   ...
   public function setFreight($nrzipcode){
    ...
    if ($totals['nrqtd'] > 0){
        ...
        $xml = simplexml_load_file("http://ws.correios.com.br/calculador/CalcPrecoPrazo.asmx/CalcPrecoPrazo?nCdEmpresa=&sDsSenha=&nCdServico=04014&sCepOrigem=59164000&sCepDestino=59164000&nVlPeso=0.48&nCdFormato=1&nVlComprimento=24.50&nVlAltura=16.95&nVlLargura=11&nVlDiametro=0.0&sCdMaoPropria=0&nVlValorDeclarado=50.0&sCdAvisoRecebimento=S");
